...
const Interactions = () => {
  ...
  let temp = [
    ...
    "Taste, health, or comfort‚ what defines good food and is it the same for everyone?",
    ...
    "Sharing, savoring, and celebrating meals‚how do they transcend necessity to become sacred traditions?",
    "Recipes are whispers of ancestral wisdom. What stories and lessons do they carry?",
    "The making, sharing, and savoring of food‚does the journey matter more than the dish?",
