...
Command: npx gltfjsx@6.5.3 FINAL_globe.glb -k 
*/
...
export function FGlobeModel(props) {
  const { nodes, materials } = useGLTF("/Models/FINAL_globe.glb");
  ...
  useGSAP(() => {
    if (statesVisible) {
      gsap.to(statesRef.current.scale, {
        x: 1,
        y: 1,
        z: 1,
        duration: 0.01,
    ...
    if (districtsVisible) {
      gsap.to(districtsRef.current.scale, {
        x: 1,
        y: 1,
        z: 1,
        duration: 0.01,
    ...
    >
      <group ref={rotRef}>
        ...
        >
          ...
          <group name="IndianStates" scale={0} ref={statesRef}>
            <group
              name="NEPAL"
              position={[-0.012, 0.024, 0.973]}
              rotation={[0.082, 0.18, 0.013]}
          ...
          <group name="TamilNadu" scale={0} ref={districtsRef}>
            <group
              name="TN_CHETTI"
              position={[-0.012, 0.024, 0.973]}
              rotation={[0.082, 0.18, 0.013]}
...
useGLTF.preload("/FINAL_globe.glb");
